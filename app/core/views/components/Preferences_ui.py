...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.demPathWidget = QtWidgets.QWidget(self.mainWidget)
        self.demPathWidget.setObjectName("demPathWidget")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.demPathWidget)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.demPathLabel = QtWidgets.QLabel(self.demPathWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.demPathLabel.setFont(font)
        self.demPathLabel.setObjectName("demPathLabel")
        self.horizontalLayout_8.addWidget(self.demPathLabel)
        self.demPathLineEdit = QtWidgets.QLineEdit(self.demPathWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.demPathLineEdit.setFont(font)
        self.demPathLineEdit.setObjectName("demPathLineEdit")
        self.horizontalLayout_8.addWidget(self.demPathLineEdit)
        self.demPathButton = QtWidgets.QPushButton(self.demPathWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.demPathButton.setFont(font)
        self.demPathButton.setAutoDefault(False)
        self.demPathButton.setObjectName("demPathButton")
        self.horizontalLayout_8.addWidget(self.demPathButton)
        self.verticalLayout_2.addWidget(self.demPathWidget)
    ...
    def retranslateUi(self, Preferences):
        ...
        self.demPathLabel.setText(_translate("Preferences", "DEM Directory:"))
        self.demPathButton.setText(_translate("Preferences", "Browse"))
