...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.demWidget)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.demFolderLabel = QtWidgets.QLabel(self.demWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.demFolderLabel.setFont(font)
        self.demFolderLabel.setObjectName("demFolderLabel")
        self.horizontalLayout_8.addWidget(self.demFolderLabel)
        self.demFolderLineEdit = QtWidgets.QLineEdit(self.demWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.demFolderLineEdit.setFont(font)
        self.demFolderLineEdit.setObjectName("demFolderLineEdit")
        self.horizontalLayout_8.addWidget(self.demFolderLineEdit)
        self.demFolderButton = QtWidgets.QPushButton(self.demWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.demFolderButton.setFont(font)
        self.demFolderButton.setObjectName("demFolderButton")
        self.horizontalLayout_8.addWidget(self.demFolderButton)
    ...
    def retranslateUi(self, Preferences):
        ...
        self.demFolderLabel.setText(_translate("Preferences", "DEM Folder:"))
        self.demFolderButton.setText(_translate("Preferences", "Browse"))
